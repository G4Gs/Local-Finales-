...
class Localidad extends \App\Entity\Localidad implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Localidad' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Localidad' . "\0" . 'nombre', '' . "\0" . 'App\\Entity\\Localidad' . "\0" . 'codigo_postal', '' . "\0" . 'App\\Entity\\Localidad' . "\0" . 'provincia', '' . "\0" . 'App\\Entity\\Localidad' . "\0" . 'persona', '' . "\0" . 'App\\Entity\\Localidad' . "\0" . 'instituto', '' . "\0" . 'App\\Entity\\Localidad' . "\0" . 'region'];
        }
