 ...
 */
class Revista extends \App\Entity\Revista implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Revista' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Revista' . "\0" . 'descripcion', '' . "\0" . 'App\\Entity\\Revista' . "\0" . 'cursada_docente'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Revista $proxy) {
