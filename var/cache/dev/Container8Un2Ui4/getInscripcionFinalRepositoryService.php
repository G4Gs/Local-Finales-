...
<<<<<<< HEAD:var/cache/dev/Container8Un2Ui4/getInscripcionFinalRepositoryService.php
namespace Container8Un2Ui4;
=======
<<<<<<<< HEAD:var/cache/dev/ContainerZedAest/getInscripcionFinalRepositoryService.php
namespace ContainerZedAest;

========
namespace ContainerWxp6ynK;
>>>>>>>> 15004e1e441728d7bfb90a33f34e34e28484990f:var/cache/dev/ContainerWxp6ynK/getInscripcionFinalRepositoryService.php
>>>>>>> 9ff131dc3f1d539d565d1ea1bbe799cf5823e506:var/cache/dev/ContainerWxp6ynK/getInscripcionFinalRepositoryService.php
 ...
 */
class getInscripcionFinalRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\InscripcionFinalRepository' shared autowired service.
     *
     * @return \App\Repository\InscripcionFinalRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'InscripcionFinalRepository.php';

        return $container->privates['App\\Repository\\InscripcionFinalRepository'] = new \App\Repository\InscripcionFinalRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
