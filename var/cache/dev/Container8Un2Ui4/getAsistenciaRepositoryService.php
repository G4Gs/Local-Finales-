...
<<<<<<< HEAD:var/cache/dev/Container8Un2Ui4/getAsistenciaRepositoryService.php
namespace Container8Un2Ui4;
=======
<<<<<<<< HEAD:var/cache/dev/ContainerZedAest/getAsistenciaRepositoryService.php
namespace ContainerZedAest;

========
namespace ContainerWxp6ynK;
>>>>>>>> 15004e1e441728d7bfb90a33f34e34e28484990f:var/cache/dev/ContainerWxp6ynK/getAsistenciaRepositoryService.php
>>>>>>> 9ff131dc3f1d539d565d1ea1bbe799cf5823e506:var/cache/dev/ContainerWxp6ynK/getAsistenciaRepositoryService.php
 ...
 */
class getAsistenciaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AsistenciaRepository' shared autowired service.
     *
     * @return \App\Repository\AsistenciaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AsistenciaRepository.php';

        return $container->privates['App\\Repository\\AsistenciaRepository'] = new \App\Repository\AsistenciaRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
