...
const cursoId = ";
        // line 66
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["curso"]) || array_key_exists("curso", $context) ? $context["curso"] : (function () { throw new RuntimeError('Variable "curso" does not exist.', 66, $this->source); })()), "id", [], "any", false, false, false, 66), "html", null, true);
        yield ";
const puedeEditar = ";
        // line 67
