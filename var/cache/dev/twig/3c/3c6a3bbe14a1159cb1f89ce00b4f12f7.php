...
class __TwigTemplate_987e0d01529369695ece0103506ebe96 extends Template
{
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["field"]) {
            ...
            ";
            // line 7
            yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($context["field"], 'widget', ["attr" => ["class" => ("home-input" . (((($tmp = CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["field"], "vars", [], "any", false, false, false, 7), "valid", [], "any", false, false, false, 7)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("") : (" is-invalid")))]]);
            yield "
            ";
            // line 8
