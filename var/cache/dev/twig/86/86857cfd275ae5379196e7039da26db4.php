...
";
        // line 7
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["examen_final"]) || array_key_exists("examen_final", $context) ? $context["examen_final"] : (function () { throw new RuntimeError('Variable "examen_final" does not exist.', 7, $this->source); })()), "id", [], "any", false, false, false, 7)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 8
...
{% endif %}", "examen_final/_form.html.twig", "C:\\xampp\\htdocs\\Local-Finales-\\templates\\examen_final\\_form.html.twig");
    }
}
