        ...
        foreach ($context['_seq'] as $context["_key"] => $context["curso"]) {
           ...
           <td>
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["horario"]) {
                // line 51
                yield "                ";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["horario"], "dia", [], "any", false, false, false, 51), "html", null, true);
                yield ": ";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["horario"], "horarioInicio", [], "any", false, false, false, 51), "html", null, true);
                yield " a ";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["horario"], "horarioFin", [], "any", false, false, false, 51), "html", null, true);
                yield "<br>
            ";
            ...
            <td>";
            // line 56
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["curso"], "getAsignatura", [], "any", false, false, false, 56), "nombre", [], "any", false, false, false, 56), "html", null, true);
            yield "</td>
            <td>";
            // line 57
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["curso"], "getComision", [], "any", false, false, false, 57), "comision", [], "any", false, false, false, 57), "html", null, true);
            yield "</td>
            <td>
                <a href=\"";
            // line 59
...
";
    ...
    {
        return array (  200 => 72,  194 => 68,  185 => 64,  183 => 67,  175 => 60,  171 => 59,  166 => 57,  162 => 56,  159 => 55,  152 => 53,  150 => 54,  139 => 51,  134 => 50,  129 => 48,  125 => 47,  122 => 46,  117 => 45,  103 => 33,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
        ...
        <tr>
           ...
           <td>
            {% for horario in curso.horarios %}
                {{ horario.dia }}: {{ horario.horarioInicio }} a {{ horario.horarioFin }}<br>
            {% else %}
                Sin horarios
            {% endfor %}
        </td>
