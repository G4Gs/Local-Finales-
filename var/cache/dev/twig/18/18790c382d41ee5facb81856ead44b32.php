...
class __TwigTemplate_7bad9645294affedc47c7a6662e8f57b extends Template
{
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        // line 6
        yield "    <h1>Listado de Provincias</h1>
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["provincium"]) {
            ...
            yield "            <tr>
                <td>";
            // line 19
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["provincium"], "id", [], "any", false, false, false, 19), "html", null, true);
            yield "</td>
                <td>";
            // line 20
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["provincium"], "descripcion", [], "any", false, false, false, 20), "html", null, true);
            yield "</td>
                <td>
                    <a href=\"";
            // line 22
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_provincia_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["provincium"], "id", [], "any", false, false, false, 22)]), "html", null, true);
            yield "\">Mostrar</a>
                    <a href=\"";
            // line 23
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_provincia_edit", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["provincium"], "id", [], "any", false, false, false, 23)]), "html", null, true);
            yield "\">Editar</a>
                </td>
            </tr>
        ";
        ...
        unset($context['_seq'], $context['_key'], $context['provincium'], $context['_parent'], $context['_iterated']);
    ...
    <a href=\"";
        ...
        yield "\">Incorporar Nueva Provincia</a>
";
...
{% endblock %}
", "provincia/index.html.twig", "C:\\xampp\\htdocs\\Local-Finales-\\templates\\provincia\\index.html.twig");
    }
}
