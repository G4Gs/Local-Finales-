...
class __TwigTemplate_a437cc8ecba9f4861796eefcdc3bae84 extends Template
{
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["curso"]) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["cursada"]) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["asistencia"]) {
                    ...
                    // line 379
                    if ((($tmp =  !CoreExtension::getAttribute($this->env, $this->source, $context["loop"], "last", [], "any", false, false, false, 379)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                        yield ",";
                    }
                    // line 380
                    yield "                                ";
                ...
                // line 382
                if ((($tmp =  !CoreExtension::getAttribute($this->env, $this->source, $context["loop"], "last", [], "any", false, false, false, 382)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    yield ",";
                }
                // line 383
                yield "                    ";
            ...
            // line 385
            if ((($tmp =  !CoreExtension::getAttribute($this->env, $this->source, $context["loop"], "last", [], "any", false, false, false, 385)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                yield ",";
            }
            // line 386
            yield "        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["cursada"]) {
                ...
                if ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["cursada"], "curso", [], "any", false, false, false, 791), "comision", [], "any", false, false, false, 791), "ciclolectivo", [], "any", false, false, false, 791) == CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["curso"], "comision", [], "any", false, false, false, 791), "ciclolectivo", [], "any", false, false, false, 791))) {
                    ...
                    yield ", 'parcial')\" 
                                        ";
                    // line 799
                    if ((($tmp =  !(null === CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["cursada"], "getNotaId", [], "method", false, false, false, 799), "parcial", [], "any", false, false, false, 799))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    ...
                    yield ", 'recuperatorio1')\" 
                                        ";
                    // line 808
                    if ((($tmp =  !(null === CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["cursada"], "getNotaId", [], "method", false, false, false, 808), "recuperatorio1", [], "any", false, false, false, 808))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                        yield "style=\"display: none;\"";
                    }
                    // line 809
                    yield "                                    >
                    ...
                    yield ", 'parcial2')\" 
                                        ";
                    // line 817
                    if ((($tmp =  !(null === CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["cursada"], "getNotaId", [], "method", false, false, false, 817), "parcial2", [], "any", false, false, false, 817))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                        yield "style=\"display: none;\"";
                    }
                    // line 818
                    yield "                                    >
                    ...
                    yield ", 'recuperatorio2')\" 
                                        ";
                    // line 826
                    if ((($tmp =  !(null === CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["cursada"], "getNotaId", [], "method", false, false, false, 826), "recuperatorio2", [], "any", false, false, false, 826))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                        yield "style=\"display: none;\"";
                    }
                    // line 827
                    yield "                                    >
