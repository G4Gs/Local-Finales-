...
/* base2.html.twig */
class __TwigTemplate_18baac708bf2a1ae12cb2f3b505e28b7 extends Template
{
...
\t\t\t\t\t\t\t\t\t\t";
            ...
            yield "
\t\t\t\t\t\t\t\t\t\t";
        } elseif ((($tmp = $this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("ROLE_DOCENTE")) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 353
            yield "\t\t\t\t\t\t\t\t\t\t\t";
            ...
            yield "
\t\t\t\t\t\t\t\t\t\t";
        } elseif ((($tmp = $this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("ROLE_ALUMNO")) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 355
            yield "\t\t\t\t\t\t\t\t\t\t\t";
...
\t\t\t</body>
\t\t</body>
\t</html>", "base2.html.twig", "C:\\xampp\\htdocs\\Local-Finales-\\templates\\base2.html.twig");
    }
}
